...
public final class DataTypeWebService_DataTypeWebServiceImplPort_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        {
        System.out.println("Invoking addUsers2...");
        com.minyazi.j2ee.test.webservice.client2.MapConvertor _addUsers2_arg0 = null;
        port.addUsers2(_addUsers2_arg0);
        ...
        com.minyazi.j2ee.test.webservice.client2.MapConvertor _getUsers__return = port.getUsers();
        ...
        com.minyazi.j2ee.test.webservice.client2.User _getUserById__return = port.getUserById(_getUserById_arg0);
        ...
        com.minyazi.j2ee.test.webservice.client2.User _isExist_arg0 = null;
        ...
        java.util.List<com.minyazi.j2ee.test.webservice.client2.User> _getUsersByName__return = port.getUsersByName(_getUsersByName_arg0);
        System.out.println("getUsersByName.result=" + _getUsersByName__return);


        }
        {
        System.out.println("Invoking addUsers...");
        java.util.List<com.minyazi.j2ee.test.webservice.client2.User> _addUsers_arg0 = null;
        port.addUsers(_addUsers_arg0);
