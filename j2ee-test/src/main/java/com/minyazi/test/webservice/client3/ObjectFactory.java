 ...
 * generated in the com.minyazi.test.webservice.client3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorld_QNAME = new QName("http://webservice.service.minyazi.com/", "sayHelloWorld");
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://webservice.service.minyazi.com/", "sayHelloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.minyazi.test.webservice.client3
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.service.minyazi.com/", name = "sayHelloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.service.minyazi.com/", name = "sayHelloWorldResponse")
