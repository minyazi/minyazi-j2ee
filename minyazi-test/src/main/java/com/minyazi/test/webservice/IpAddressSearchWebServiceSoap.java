...
public interface IpAddressSearchWebServiceSoap {
    ...
    @RequestWrapper(localName = "getCountryCityByIp", targetNamespace = "http://WebXml.com.cn/", className = "com.minyazi.test.webservice.GetCountryCityByIp")
    @WebMethod(action = "http://WebXml.com.cn/getCountryCityByIp")
    @ResponseWrapper(localName = "getCountryCityByIpResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.minyazi.test.webservice.GetCountryCityByIpResponse")
    public com.minyazi.test.webservice.ArrayOfString getCountryCityByIp(
    ...
    @RequestWrapper(localName = "getVersionTime", targetNamespace = "http://WebXml.com.cn/", className = "com.minyazi.test.webservice.GetVersionTime")
    @WebMethod(action = "http://WebXml.com.cn/getVersionTime")
    @ResponseWrapper(localName = "getVersionTimeResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.minyazi.test.webservice.GetVersionTimeResponse")
    ...
    @RequestWrapper(localName = "getGeoIPContext", targetNamespace = "http://WebXml.com.cn/", className = "com.minyazi.test.webservice.GetGeoIPContext")
    @WebMethod(action = "http://WebXml.com.cn/getGeoIPContext")
    @ResponseWrapper(localName = "getGeoIPContextResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.minyazi.test.webservice.GetGeoIPContextResponse")
